...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      /*
       * `font-medium`, not the upstream `font-normal`. These are small light
       * digits on a near-black panel, which is the worst case for Windows'
       * subpixel text rendering — at a thin weight the strokes pick up visible
       * red and blue fringing and the grid reads as unevenly coloured. A little
       * more weight per stroke is the part of that we can actually control.
       */
      className={cn(
